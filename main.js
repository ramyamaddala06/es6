...
//let theString = 'Hello,my name is Shivani and I love Javascript';
...
getData('GET', 'https://jsonplaceholder.typicode.com/todos').then(function(){
	console.log(data);
}).catch(function(err){
	console.log(err);
});
